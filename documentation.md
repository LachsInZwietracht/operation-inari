...
- **Not built yet:** barcode scanning, training tracking, and importing a client log range into `nutrition_protocols`. See the milestones in `docs/client-mode-plan.md`.
