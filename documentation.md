...
- **Direct exports:** The day toolbar can export the current plan as a clinical PDF, patient handout, or 7-day Lehrküchenplan. Exports reuse `/api/exports/report` (file generation only; patient-bound report persistence was removed) and use `lib/exports/report-builder.ts` variant payloads.
