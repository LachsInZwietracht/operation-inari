...
function n(values: Record<string, number>): NutrientValue[] {
  const ids = [
    ...
    "vitamin_c", "vitamin_d", "vitamin_e", "vitamin_k", "folsaeure", "niacin",
    "calcium", "eisen", "magnesium", "kalium", "natrium", "zink", "phosphor", "jod", "mangan",
  ];
...
export const FOODS: Food[] = [
  ...
  {
    id: "food_brokkoli", name: "Brokkoli", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G312100", foodGroupId: "fg_G2", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_tomate", name: "Tomate", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G561100", foodGroupId: "fg_G3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_spinat", name: "Spinat", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G211100", foodGroupId: "fg_G1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_paprika", name: "Paprika (rot)", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G543100", foodGroupId: "fg_G3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_zucchini", name: "Zucchini", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G582100", foodGroupId: "fg_G3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_gurke", name: "Gurke", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G520100", foodGroupId: "fg_G3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  // Obst
  {
    id: "food_apfel", name: "Apfel", categoryId: "cat_obst", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "F110100", foodGroupId: "fg_O1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_banane", name: "Banane", categoryId: "cat_obst", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "F503100", foodGroupId: "fg_O5", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_erdbeere", name: "Erdbeere", categoryId: "cat_obst", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "F301100", foodGroupId: "fg_O3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_heidelbeere", name: "Heidelbeere", categoryId: "cat_obst", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "F304100", foodGroupId: "fg_O3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  // Fleisch
  {
    id: "food_haehnchenbrust", name: "Haehnchenbrust", categoryId: "cat_fleisch", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "V416100", foodGroupId: "fg_R3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  // Fisch
  {
    id: "food_lachs", name: "Lachs", categoryId: "cat_fisch", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "T410100", foodGroupId: "fg_S1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  // Milchprodukte
  {
    id: "food_vollmilch", name: "Vollmilch (3,5 %)", categoryId: "cat_milch", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "M111300", foodGroupId: "fg_M1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_joghurt", name: "Joghurt natur (3,5 %)", categoryId: "cat_milch", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "M141300", foodGroupId: "fg_M2", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_magerquark", name: "Magerquark", categoryId: "cat_milch", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "M713100", foodGroupId: "fg_M4", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_gouda", name: "Gouda", categoryId: "cat_milch", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "M402600", foodGroupId: "fg_M3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  // Getreide
  {
    id: "food_haferflocken", name: "Haferflocken", categoryId: "cat_getreide", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "C133000", foodGroupId: "fg_C3", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_vollkornbrot", name: "Vollkornbrot", categoryId: "cat_getreide", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "B101000", foodGroupId: "fg_B4", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_reis", name: "Reis (gekocht)", categoryId: "cat_getreide", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "C352032", foodGroupId: "fg_C4", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_nudeln", name: "Nudeln (gekocht)", categoryId: "cat_getreide", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "X432142", foodGroupId: "fg_C5", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  // Huelsenfruechte
  {
    id: "food_rote_linsen", name: "Rote Linsen (gekocht)", categoryId: "cat_huelsenfruechte", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "H730032", foodGroupId: "fg_G6", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  // Nuesse & Samen
  {
    id: "food_mandeln", name: "Mandeln", categoryId: "cat_nuesse", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "H210100", foodGroupId: "fg_N1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_walnuesse", name: "Walnuesse", categoryId: "cat_nuesse", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "H120100", foodGroupId: "fg_N1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_honig", name: "Honig", categoryId: "cat_getraenke", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "S120000", foodGroupId: "fg_T1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_salz", name: "Speisesalz", categoryId: "cat_oele", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "R111000", foodGroupId: "fg_W2", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_knoblauch", name: "Knoblauch", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G490100", foodGroupId: "fg_G5", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  {
    id: "food_petersilie", name: "Petersilie", categoryId: "cat_gemuese", source: "BLS 3.02", sourceId: "bls", sourceVersion: "3.02", blsCode: "G250100", foodGroupId: "fg_W1", baseAmount: 100, ...ts,
    nutrients: n({
  ...
  },
  {
    id: "food_sfk_quinoa",
    name: "Quinoa (SFK)",
    categoryId: "cat_getreide",
    source: "SFK Referenz 2025",
    sourceId: "sfk",
    sourceVersion: "2025 Q4",
    baseAmount: 100,
    ...ts,
    nutrients: n({
      energie: 368,
  ...
  {
    id: "food_usda_blackbeans",
    name: "Black Beans (USDA)",
    categoryId: "cat_huelsenfruechte",
  ...
  {
    id: "food_usda_blueberries",
    name: "Blaubeeren (USDA)",
    categoryId: "cat_obst",
    source: "USDA FoodData",
    sourceId: "usda",
    sourceVersion: "2026-01",
