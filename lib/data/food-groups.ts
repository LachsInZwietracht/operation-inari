...
export const FOOD_GROUPS: FoodGroupNode[] = [
  ...
  },
  {
    ...
    children: [
      { id: "fg_S1", name: "Zucker und Honig" },
      { id: "fg_S2", name: "Schokolade und Konfekt" },
      { id: "fg_S3", name: "Speiseeis" },
    ],
  },
  {
    id: "fg_T",
    ...
    children: [
      { id: "fg_T1", name: "Seefisch" },
      { id: "fg_T2", name: "Süßwasserfisch" },
      { id: "fg_T3", name: "Meeresfrüchte" },
      { id: "fg_T4", name: "Fischerzeugnisse" },
    ],
  },
  {
    id: "fg_W",
