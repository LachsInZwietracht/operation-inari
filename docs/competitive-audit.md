...
- **Recipe and meal planning workflows:** Recipe CRUD, Meal-Master-style import support, cached nutrient totals, meal planning, print/report handoff, production and shopping outputs for institution menus.
- **Patient and clinical workspace:** Patients, anthropometrics, diagnoses, medications, screenings, lab values, activity, therapy settings, PROCAM, allergens, counseling sessions, counseling templates, and patient-bound report history.
