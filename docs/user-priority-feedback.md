...
1. **Intuitive design, low onboarding effort.** Keep workflows simple and motivating; minimize training time.
   ...
   - _Update (2026-08-26):_ The patient planner now separates dated **Versionen & Freigaben** from reusable templates, groups those day-specific revisions by calendar week, and can safely carry a visible week forward into one to twelve future weeks. Existing drafts are preserved by default, while released and historical stands cannot be overwritten. See `documentation.md` section 4.17.
