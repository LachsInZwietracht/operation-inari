...
import type { CounselingSession, Patient, PatientMailMergeExportRequest } from "@/lib/types"
...
export function PatientenPageClient({ initialPatients, initialSessions }: PatientenPageClientProps) {
