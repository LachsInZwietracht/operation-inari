...
interface AbrechnungPageClientProps {
  initialInvoices?: InvoiceEntry[]
  initialAppointments?: PracticeAppointment[]
  initialPatients?: Patient[]
}

export function AbrechnungPageClient({
  initialInvoices,
  initialAppointments,
  initialPatients,
}: AbrechnungPageClientProps) {
  const { invoices, addInvoice, markInvoiceStatus } = usePracticeInvoices({ initialInvoices })
